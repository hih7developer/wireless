                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <input type="email" class="form-control" placeholder="info@gmail.com" name="user[email]" autocomplete="off" required>
                           </div>
                           ...
                           <div class="text-center d-flex justify-content-center">
                              ...
                              <div class="g-recaptcha" data-sitekey="6Le_J7YUAAAAAJHkzjowlbpGpfWQin7hvOC3x6k1"></div>
                           </div>
