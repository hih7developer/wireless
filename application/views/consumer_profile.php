                ...
                <div class="profile_info_sec">
                    ...
                    <div class="passchange_sec">
                        ...
                        <form
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control" name="new_ps" passwordCheck="passwordCheck"
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control" name="con_ps"
...
$(document).ready(function() {
    ...
    google.maps.event.addListener(autocomplete, 'place_changed', function() {
        ...
        $('#street_address').val(place.address_components[0].short_name + ' ' + place
    ...
    google.maps.event.addListener(autocomplete_shipping, 'place_changed', function() {
        ...
        $('#shipping_address').val(place.address_components[0].short_name + ' ' + place
            .address_components[1].short_name);
        for (var i = 0; i < place.address_components.length; i++) {
            var addressType = place.address_components[i].types[0];
