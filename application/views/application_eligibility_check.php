            ...
            <div class="capa-outr">
                ...
                <div class="profile_info_sec">
                    <div class="personalinfo_sec cmmn_title">
                        <form action="<?php echo base_url('ApplicationController/nv_check/'.$plan_id) ?>" id="consumer_profile_form" method="post" class="needs-validation" novalidate>
...
<!-- Modal -->
<div class="modal fade" id="signatureModelOne" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<!-- Modal -->
<div class="modal fade" id="signatureModelTwo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Sign Here</h5>
...
$(document).ready(function() {
    ...
    google.maps.event.addListener(autocomplete_shipping, 'place_changed', function() {
        ...
        $('#shipping_address').val(place.address_components[0].long_name+' '+place.address_components[1].long_name);
        for (var i = 0; i < place.address_components.length; i++) {
            var addressType = place.address_components[i].types[0];
...
<script>
    window.open("<?php echo $this->session->flashdata('nv_error_links')[$link_key]['href'] ?>", '_blank', 'location=yes,height=900,width=1000,scrollbars=yes,status=yes');
</script>
<?php endif; ?>
...
(function($){
    ...
    $('#signatureOne').signature({syncField: '#signatureJSONOne'});
    ...
    $('#signatureTwo').signature({syncField: '#signatureJSONTwo'});
