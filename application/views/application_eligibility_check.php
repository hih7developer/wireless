            ...
            <div class="capa-outr">
                ...
                <div class="profile_info_sec">
                    <div class="personalinfo_sec w-100 cmmn_title">
                        <form action="<?php echo base_url('ApplicationController/nv_check/' . $plan_id) ?>"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group user">
                                        ...
                                        <input type="text" name="consumer[first_name]"
                                            class="form-control profile_field" placeholder="Type first name here"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group user">
                                        ...
                                        <input type="text" name="consumer[last_name]" class="form-control profile_field"
                                            placeholder="Type last name here" value="<?php echo $consumer->last_name ?>"
                                            required />
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" name="consumer[contact_no]"
                                            class="form-control cleave-input-phone profile_field"
                                            placeholder="012-345-6789" value="<?php echo $consumer->contact_no ?>"
                                            required />
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <!-- <div class="input-group date"
                                            data-date-format="mm-dd-yyyy" value="<?php echo  is_null($consumer->dob) ? null : date('m/d/Y', strtotime($consumer->dob)) ?>"> -->
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="consumer[ssn]" class="form-control profile_field"
                                            placeholder="Enter 4 off SSN No" value="<?php echo $consumer->ssn ?>"
                                            maxlength="4"
                                ...
                                <div class="col-md-12">
                                    <div class="adflx">
                                        <label class="container">Permanent
                                            <input class="profile_field" type="radio" name="consumer[address_type]"
                                                value="permanent"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="city" name="consumer[city]"
                                            class="form-control profile_field" placeholder="Enter City"
                                            value="<?php echo $consumer->city ?>" required />
                                        <div class="invalid-feedback">
                                            Please enter city.
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="consumer[rep_id]" id="rep_id" class="form-control" placeholder="" aria-describedby="helpId">
                                        <small id="helpId" class="text-muted">Provided if a representative assisted with the transaction otherwise leave it blank.</small>
                                    </div>
                                </div>
                            </div>
                        </div> -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="consumer[shipping_city]" id="shipping_city"
                                                    class="form-control profile_field" placeholder="Enter City"
                ...
                <div class="col-md-12 mt-4 d-flex justify-content-between">
                    <button type="submit" class="btn btn-default formbtn ml-auto"
                        form="consumer_profile_form">Next</button>
                </div>
            </div>
        </div>
    </div>
...
$(document).ready(function() {
    ...
    google.maps.event.addListener(autocomplete, 'place_changed', function() {
        ...
        $('#street_address').val(place.address_components[0].long_name + ' ' + place.address_components[
            1].long_name);
    ...
    google.maps.event.addListener(autocomplete_shipping, 'place_changed', function() {
        ...
        $('#shipping_address').val(place.address_components[0].long_name + ' ' + place
...
$(document).on('change', '#state', function() {
    ...
    household_change($(this).val());
});

function household_change(state_id) {
    var nv_disbled_states = ["6", "43", "51", "53"];
    if (nv_disbled_states.includes(state_id)) {
        $.ajax({
            url: '<?php echo base_url('ApplicationController/get_household_worksheet') ?>',
            success: function(data) {
                $('#household_worksheet_div').html(data);
            }
        });

    } else {
        $('#household_worksheet_div').html('');
    }
}
</script>
...
<?php if ($this->session->flashdata('nv_error_links')) : ?>
<?php $link_key = $this->session->flashdata('nv_error_status') == 'PENDING_RESOLUTION' ? 'resolution' : 'certification' ?>
<script>
window.open("<?php echo $this->session->flashdata('nv_error_links')[$link_key]['href'] ?>", '_blank',
...
<?php if ($this->session->flashdata('nv_forbidden_error')) : ?>
<script>
Swal.fire({
    icon: 'error',
    title: 'Oops...',
    text: "<?php echo $this->session->flashdata('nv_forbidden_error') ?>",
})
</script>
<?php endif; ?>
